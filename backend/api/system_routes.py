...
async def get_status(state=Depends(get_app_state)):
    ...
    status["qwen3_asr_preview_max_line_length"] = int(getattr(state.asr_engine, "qwen3_preview_max_line_length", 20) or 20)
...
async def update_orchestrator_config(payload: OrchestratorConfigPayload, state=Depends(get_app_state)):
    ...
    old_qwen3_preview_max_line_length = int(getattr(state.asr_engine, "qwen3_preview_max_line_length", 20) or 20)
    ...
    state.asr_engine.qwen3_preview_max_line_length = int(config.qwen3_asr_preview_max_line_length)
    ...
    if state.asr_engine.is_loaded and (
        ...
        or old_qwen3_preview_max_line_length != int(config.qwen3_asr_preview_max_line_length)

...
export function normalizeOrchestratorConfig(raw) {
  ...
  return {
    ...
    mcp_enabled: Boolean(raw.mcp_enabled ?? false),
    mcp_mount_path: raw.mcp_mount_path ?? "/mcp",
    ...
    music_turbo_model_dir: raw.music_turbo_model_dir ?? raw.music_model_dir ?? "",
    music_base_model_dir: raw.music_base_model_dir ?? raw.music_model_dir ?? "",
    music_model_variant: raw.music_model_variant ?? "turbo",
    music_model_dir: raw.music_model_dir ?? "",
    music_device_mode: raw.music_device_mode ?? "cpu_offload",
    asr_backend: raw.asr_backend ?? "whisper",
    asr_model_path: raw.asr_model_path ?? "base",
    asr_device: raw.asr_device ?? "cuda:0",
    asr_vocal_separation_enabled: Boolean(raw.asr_vocal_separation_enabled ?? false),
    asr_vocal_separation_model: raw.asr_vocal_separation_model ?? "htdemucs",
    asr_vocal_separation_repo_dir: raw.asr_vocal_separation_repo_dir ?? "",
    asr_vocal_separation_device: raw.asr_vocal_separation_device ?? raw.asr_device ?? "cuda:0",
    qwen3_asr_crispasr_exe: raw.qwen3_asr_crispasr_exe ?? "",
    qwen3_asr_model_path: raw.qwen3_asr_model_path ?? "",
    qwen3_asr_forced_aligner_model_path: raw.qwen3_asr_forced_aligner_model_path ?? "",
    ...
    firered_asr_enable_timestamps: Boolean(raw.firered_asr_enable_timestamps ?? true),
    firered_asr_enable_punctuation: Boolean(raw.firered_asr_enable_punctuation ?? false),
    firered_asr_punc_model_path: raw.firered_asr_punc_model_path ?? "",
...
export function toOrchestratorPayload(config) {
  return {
    ...
    mcp_enabled: Boolean(config.mcp_enabled ?? false),
    mcp_mount_path: config.mcp_mount_path ?? "/mcp",
    ...
    music_turbo_model_dir: config.music_turbo_model_dir ?? config.music_model_dir ?? "",
    music_base_model_dir: config.music_base_model_dir ?? config.music_model_dir ?? "",
    music_model_variant: config.music_model_variant ?? "turbo",
    music_model_dir: config.music_model_dir ?? "",
    music_device_mode: config.music_device_mode ?? "cpu_offload",
    asr_backend: config.asr_backend ?? "whisper",
    asr_model_path: config.asr_model_path ?? "base",
    asr_device: config.asr_device ?? "cuda:0",
    asr_vocal_separation_enabled: Boolean(config.asr_vocal_separation_enabled ?? false),
    asr_vocal_separation_model: config.asr_vocal_separation_model === "htdemucs_ft" ? "htdemucs_ft" : "htdemucs",
    asr_vocal_separation_repo_dir: config.asr_vocal_separation_repo_dir ?? "",
    asr_vocal_separation_device: config.asr_vocal_separation_device ?? config.asr_device ?? "cuda:0",
    qwen3_asr_crispasr_exe: config.qwen3_asr_crispasr_exe ?? "",
    qwen3_asr_model_path: config.qwen3_asr_model_path ?? "",
    qwen3_asr_forced_aligner_model_path: config.qwen3_asr_forced_aligner_model_path ?? "",
    ...
    firered_asr_enable_timestamps: Boolean(config.firered_asr_enable_timestamps ?? true),
    firered_asr_enable_punctuation: Boolean(config.firered_asr_enable_punctuation ?? false),
    firered_asr_punc_model_path: config.firered_asr_punc_model_path ?? "",
